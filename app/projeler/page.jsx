...
export default function ProjectsPage() {
  ...
  const projects = [
    ...
    },
    {
      id: 7,
      title: {
        tr: "Ulusoy Gıda - İzlenebilirlik & Web Sistemi",
        en: "Ulusoy Gıda - Traceability & Web System",
        de: "Ulusoy Gıda - Rückverfolgbarkeit & Web-System",
      },
      category: "web",
      icon: Code,
      color: "#06B6D4",
      image: "/modern-ecommerce-dashboard.png",
      description: {
        tr: "Ulusoy Gıda için QR kod tabanlı ürün izlenebilirlik sistemi ve kurumsal web platformu. Taze balık ve deniz ürünlerinin kaynaktan tüketiciye tüm süreç boyunca takibi.",
        en: "QR code-based product traceability system and corporate web platform for Ulusoy Gıda. Tracking fresh fish and seafood from source to consumer throughout the entire process.",
        de: "QR-Code-basiertes Produktrückverfolgbarkeitssystem und Unternehmens-Webplattform für Ulusoy Gıda. Verfolgung von frischem Fisch und Meeresfrüchten von der Quelle bis zum Verbraucher.",
      },
      technologies: ["Next.js", "Node.js", "PostgreSQL", "QR System", "AWS"],
      features: {
        tr: ["QR İzlenebilirlik Sistemi", "Kurumsal Web Sitesi", "Ürün Takip Sistemi", "Tedarik Zinciri Yönetimi"],
        en: ["QR Traceability System", "Corporate Website", "Product Tracking System", "Supply Chain Management"],
        de: ["QR-Rückverfolgbarkeitssystem", "Unternehmenswebsite", "Produktverfolgungssystem", "Lieferkettenmanagement"],
      },
      duration: "4 ay",
      team: "5 kişi",
      year: "2024",
